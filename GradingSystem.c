...
void Header(){
    ...
    position(28, 8); printf("    =   Bachelor of Science in Information System(NON-STEM)   =    ");
...
void CreatingGradeReport(){
    ...
    if(fpcomputesummary != NULL){
        ...
        LoadingScreen();
            ...
            fprintf(fpgradereport, "\n\t\t\t                             www.tup.edu.ph                     ");
            fprintf(fpgradereport, "\n\t\t\t                          COLLEGE OF SCIENCES                   ");
            fprintf(fpgradereport, "\n\t\t\t          Bachelor of Science in Information System(NON-STEM)   ");
            fprintf(fpgradereport, "\n");
...
void ExitProgram(){ /// Switch 8
    while(1){ //Infinite Loop
        ...
        printf("\n\t\t\t      %c     Bachelor of Science in Information System(NON-STEM)    %c ", 186, 186);
        printf("\n\t\t\t      %c                                                            %c ", 186, 186);
        ...
        printf("\n\t\t\t      %c                                                            %c ", 186, 186);
        printf("\n\t\t\t      %c                                                            %c ", 186, 186);
        printf("\n\t\t\t      %c                      M E M B E R S                         %c ", 186, 186);
        printf("\n\t\t\t      %c                                                            %c ", 186, 186);
        printf("\n\t\t\t      %c                  BERIN,SAMANTHA MAURICE                    %c ", 186, 186);
        printf("\n\t\t\t      %c                    MALICDEM,ANTONIEL                       %c ", 186, 186);
        printf("\n\t\t\t      %c               SANCHEZ,LORDIRENE LLYLE PRINCE               %c ", 186, 186);
        printf("\n\t\t\t      %c                   TORRES,JHON PATRICK                      %c ", 186, 186);
        printf("\n\t\t\t      %c", 200);
        for(int a=1; a<=60; a++){ printf("%c", 205); }
        printf("%c",188);
        getche();
